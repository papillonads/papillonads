  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/utilities/marketing-layout/" aria-current="page" className="text-gray">
                Marketing layout
              </a>
            </li>
          </ol>
        ...
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Marketing layout</h2>
        ...
        <div className="markdown-body">
          <p>
            Marketing layout utilities build on top of <a href="../../utilities/layout/#position">primer-core utilities</a>, adding the
            option of responsive positioning.
          </p>
          <ul id="markdown-toc">
            <li>
              <a href="#responsive-position" id="markdown-toc-responsive-position">
                Responsive position
              </a>
            </li>
          </ul>
          <a name="//apple_ref/cpp/Style/Responsive%20position" className="dashAnchor" />
          <h2>
            <a id="responsive-position" className="anchor" href="#responsive-position" aria-hidden="true">
          ...
          <p>Use responsive position utilities to adjust the position of an element at different breakpoints.</p>
        </div>
        ...
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="position-relative p-6 bg-gray">
            <div className="d-inline-block position-md-absolute bottom-0 right-0 border bg-white p-2">.position-md-absolute</div>
          </div>

          <div className="float-left border m-3" style={{ width: '100px', height: '100px' }}>
            default
          </div>
          <div
            className="float-left position-lg-relative border m-3"
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;position-relative p-6 bg-gray&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;d-inline-block position-md-absolute bottom-0 right-0 border bg-white p-2&quot;</span>
                <span className="nt">&gt;</span>
                .position-md-absolute
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;float-left border m-3&quot;</span> <span className="na">style=</span>
                <span className="s">&quot;width:100px; height:100px;&quot;</span>
                <span className="nt">&gt;</span>
                default
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;float-left position-lg-relative border m-3&quot;</span> <span className="na">style=</span>
