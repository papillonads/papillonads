    ...
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/objects/layout/" aria-current="page" className="text-gray">
                Layout
              </a>
            </li>
          </ol>
        ...
        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            ...
            <a
              href="https://github.com/primer/primer/tree/master/modules/primer-layout/"
        ...
        <div className="markdown-body">
          <p>
            Primer&apos;s layout includes basic page containers and a single-tiered, fraction-based grid system. That sounds more
            complicated than it really is though—it&apos;s just containers, rows, and columns.
          </p>
          <p>
            You can find all the below styles in <code>_layout.scss</code>.
          </p>
          <a name="//apple_ref/cpp/Style/Container" className="dashAnchor" />
          <h4>
            <a id="container" className="anchor" href="#container" aria-hidden="true">
          ...
          <p>
            Center your page&apos;s contents with a <code>.container</code>.
          </p>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;container border&quot;</span>
        ...
        <div className="markdown-body">
          <p>
            The container applies <code>width: 980px;</code> and uses horizontal <code>margin</code>s to center it.
          </p>
          <a name="//apple_ref/cpp/Style/Grid" className="dashAnchor" />
          <h4>
            <a id="grid" className="anchor" href="#grid" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <h5>
            <a id="how-it-works" className="anchor" href="#how-it-works" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>
            The grid is pretty standard—you create rows with <code>.columns</code> and individual columns with a column class and fraction
            class. Here&apos;s how it works:
          </p>
          <ul>
            <li>
              Add a <code>.container</code> to encapsulate everything and provide ample horizontal gutter space.
            </li>
            <li>
              Create your outer row to clear the floated columns with <code>&lt;div className=&quot;columns&quot;&gt;</code>.
            </li>
            <li>
              Add your columns with individual <code>&lt;div className=&quot;column&quot;&gt;</code>s.
            </li>
            <li>
              Add your fractional width classes to set the width of the columns (e.g., <code>.one-fourth</code>).
            </li>
          </ul>
          <h5>
            <a id="demo" className="anchor" href="#demo" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;columns mb-1&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;one-fifth column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .one-fifth
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;four-fifths column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .four-fifths
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
                ...
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;one-fourth column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .one-fourth
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;three-fourths column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .three-fourths
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
                ...
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;one-third column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .one-third
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;two-thirds column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .two-thirds
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;columns&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;one-half column block-blue p-3 border&quot;</span>
                <span className="nt">&gt;</span>
                .one-half
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
        ...
        <div className="markdown-body">
          <h5>
            <a id="centered" className="anchor" href="#centered" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>
            Columns can be centered by adding <code>.centered</code> to the <code>.column</code> class.
          </p>
        </div>
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="columns">
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;one-half column centered block-blue border p-3&quot;</span>
                <span className="nt">&gt;</span>
                .one-half
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
      ...
      <div className="mt-4 d-flex flex-justify-between">
        ...
        <div className="align-right">
          <a href="/primer/objects/table-object/">
            Table object
            <svg
              height="14"
