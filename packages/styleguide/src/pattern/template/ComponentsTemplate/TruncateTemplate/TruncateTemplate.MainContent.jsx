    ...
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/components/truncate/" aria-current="page" className="text-gray">
                Truncate
              </a>
            </li>
          </ol>
        </nav>
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Truncate</h2>
        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            <a
              href="https://github.com/primer/primer/issues/new?title=primer-truncate"
            ...
            <a
              href="https://github.com/primer/primer/tree/master/modules/primer-truncate/"
          ...
          <div className="d-inline-block Box mr-3">
            ...
            <a className="d-inline-block px-2 py-1" href="https://npmjs.com/package/primer-truncate">
              1.4.11
            </a>
          </div>
        ...
        <div className="markdown-body">
          <p>
            <code>.css-truncate</code> will shorten text with an ellipsis. The maximum width of the truncated text can be changed by
            overriding the max-width of <code>.css-truncate-target</code>. Unless the full text is so long that it affects performace,
            always add <code>title</code> to the truncated element so the full text can still be seen.
          </p>
        </div>
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <span className="branch-ref css-truncate css-truncate-target" title="really-long-branch-name">
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;branch-ref css-truncate css-truncate-target&quot;</span> <span className="na">title=</span>
                <span className="s">&quot;really-long-branch-name&quot;</span>
        ...
        <div className="markdown-body">
          <p>
            You can reveal the entire string on hover with the addition of <code>.expandable</code>.
          </p>
        </div>
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <span className="css-truncate expandable">
            <span className="branch-ref css-truncate-target">this-is-a-really-long-branch-name</span>
          </span>
        </div>
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;css-truncate expandable&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;branch-ref css-truncate-target&quot;</span>
                <span className="nt">&gt;</span>this-is-a-really-long-branch-name<span className="nt">&lt;/span&gt;</span>
                <span className="nt">&lt;/span&gt;</span>
              </code>
            </pre>
          </div>
      ...
      <div className="mt-4 d-flex flex-justify-between">
        <div>
          <a href="/primer/components/tooltips/">
            <svg
              height="14"
