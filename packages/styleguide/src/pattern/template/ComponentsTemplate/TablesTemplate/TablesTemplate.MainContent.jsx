  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/components/tables/" aria-current="page" className="text-gray">
                Tables
              </a>
            </li>
          </ol>
        ...
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Tables</h2>

        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            <a
              href="https://github.com/primer/primer/issues/new?title=primer-tables"
            ...
            <a
              href="https://github.com/primer/primer/tree/master/modules/primer-tables/"
          ...
          <div className="d-inline-block Box mr-3">
            ...
            <a className="d-inline-block px-2 py-1" href="https://npmjs.com/package/primer-tables">
              1.5.1
            </a>
          </div>
        ...
        <div className="markdown-body">
          <p>
            <strong>
              This component will be removed, and the <code>primer-tables</code> npm package deprecated, in Primer version 11.
            </strong>
          </p>
        </div>
      </div>
