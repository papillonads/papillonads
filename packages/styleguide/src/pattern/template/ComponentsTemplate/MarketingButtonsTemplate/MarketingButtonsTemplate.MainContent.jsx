  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/components/marketing-buttons/" aria-current="page" className="text-gray">
                Marketing Buttons
              </a>
            </li>
          </ol>
        ...
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Marketing Buttons</h2>

        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            <a
              href="https://github.com/primer/primer/issues/new?title=primer-marketing-buttons"
            ...
            <a
              href="https://github.com/primer/primer/tree/master/modules/primer-marketing-buttons/"
          ...
          <div className="d-inline-block Box mr-3">
            ...
            <a className="d-inline-block px-2 py-1" href="https://npmjs.com/package/primer-marketing-buttons">
              1.0.11
            </a>
          </div>
        ...
        <div className="markdown-body">
          <p>Marketing buttons extend primer-core buttons with more color and fill styles.</p>
          <a name="//apple_ref/cpp/Style/Colors" className="dashAnchor" />
          <h2>
            <a id="colors" className="anchor" href="#colors" aria-hidden="true">
          ...
          <p>Marketing buttons are available in orange.</p>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;btn btn-orange&quot;</span> <span className="na">type=</span>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Outline%20button%20colors" className="dashAnchor" />
          <h2>
            <a id="outline-button-colors" className="anchor" href="#outline-button-colors" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>
            The <code>btn-outline</code> has also been extended with orange, purple, and green.
          </p>
        </div>

        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <button className="btn btn-outline-orange" type="button">
            Button button
          </button>
          <a className="btn btn-outline-purple" href="#url" role="button">
            Link button
          </a>
          <button className="btn btn-outline-green" type="button">
            Button button
          </button>
        </div>
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;button</span> <span className="na">class=</span>
                <span className="s">&quot;btn btn-outline-orange&quot;</span> <span className="na">type=</span>
                <span className="s">&quot;button&quot;</span>
                <span className="nt">&gt;</span>Button button<span className="nt">&lt;/button&gt;</span>
                <span className="nt">&lt;a</span> <span className="na">class=</span>
                <span className="s">&quot;btn btn-outline-purple&quot;</span> <span className="na">href=</span>
                <span className="s">&quot;#url&quot;</span> <span className="na">role=</span>
                <span className="s">&quot;button&quot;</span>
                <span className="nt">&gt;</span>Link button<span className="nt">&lt;/a&gt;</span>
                <span className="nt">&lt;button</span> <span className="na">class=</span>
                <span className="s">&quot;btn btn-outline-green&quot;</span> <span className="na">type=</span>
                <span className="s">&quot;button&quot;</span>
                <span className="nt">&gt;</span>Button button<span className="nt">&lt;/button&gt;</span>
              </code>
            </pre>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Transparent%20button" className="dashAnchor" />
          <h2>
            <a id="transparent-button" className="anchor" href="#transparent-button" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>
            A button can also be transparent and displayed with a white border with <code>btn-transparent</code>.
          </p>
        </div>

        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="bg-gray-dark p-4 mt-4">
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;bg-gray-dark p-4 mt-4&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;button</span> <span className="na">class=</span>
                <span className="s">&quot;btn btn-transparent&quot;</span> <span className="na">type=</span>
                <span className="s">&quot;button&quot;</span>
                <span className="nt">&gt;</span>
                Button button
      ...
      <div className="mt-4 d-flex flex-justify-between">
        ...
        <div className="align-right">
          <a href="/primer/components/navigation/">
            Navigation
            <svg
              height="14"
