  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/components/alerts/" aria-current="page" className="text-gray">
                Alerts
              </a>
            </li>
          </ol>
        ...
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Alerts</h2>

        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            <a
              href="https://github.com/primer/primer/issues/new?title=primer-alerts"
            ...
            <a
              href="https://github.com/primer/primer/tree/master/modules/primer-alerts/"
          ...
          <div className="d-inline-block Box mr-3">
            ...
            <a className="d-inline-block px-2 py-1" href="https://npmjs.com/package/primer-alerts">
              1.5.11
            </a>
          </div>
        ...
        <div className="markdown-body">
          <p>
            Flash messages, or alerts, inform users of successful or pending actions. Use them sparingly. Don&apos;t show more than one at a
            time.
          </p>
        ...
        <div className="markdown-body">
          <p>
            You can put multiple paragraphs of text in a flash message—the last paragraph&apos;s bottom <code>margin</code> will be
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;flash&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;p&gt;</span>This is a longer flash message in it&apos;s own paragraph. It ends up looking something
                like this. If we keep adding more text, it&apos;ll eventually wrap to a new line.<span className="nt">&lt;/p&gt;</span>
                <span className="nt">&lt;p&gt;</span>And this is another paragraph.<span className="nt">&lt;/p&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
              </code>
            </pre>
          </div>
        ...
        <div className="markdown-body">
          <p>
            Should the need arise, you can quickly space out your flash message from surrounding content with a <code>.flash-messages</code>{' '}
            wrapper. <em>Note the extra top and bottom margin in the example below.</em>
          </p>
        </div>
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;flash-messages&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;flash&quot;</span>
                <span className="nt">&gt;</span>
        ...
        <div className="markdown-body">
          ...
          <p>
            Add <code>.flash-warn</code>, <code>.flash-error</code>, or <code>.flash-success</code> to the flash message to make it yellow,
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;flash flash-warn&quot;</span>
                <span className="nt">&gt;</span>
                Flash message goes here.
                <span className="nt">&lt;/div&gt;</span>
              </code>
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;flash flash-error&quot;</span>
                <span className="nt">&gt;</span>
                Flash message goes here.
                <span className="nt">&lt;/div&gt;</span>
              </code>
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;flash flash-success&quot;</span>
                <span className="nt">&gt;</span>
                Flash message goes here.
                <span className="nt">&lt;/div&gt;</span>
              </code>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/With%20icon" className="dashAnchor" />
          <h2>
            <a id="with-icon" className="anchor" href="#with-icon" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>Add an icon to the left of the flash message to give it some funky fresh attention.</p>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;flash&quot;</span>
                <span className="nt">&gt;</span>
                <span className="err">&lt;</span>%= octicon &quot;alert&quot; %&gt; Flash message with an icon goes here.
                <span className="nt">&lt;/div&gt;</span>
              </code>
            </pre>
          </div>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/With%20dismiss" className="dashAnchor" />
          <h2>
            <a id="with-dismiss" className="anchor" href="#with-dismiss" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;flash-close js-flash-close&quot;</span> <span className="na">type=</span>
                <span className="s">&quot;button&quot;</span>
                <span className="nt">&gt;</span>
                <span className="err">&lt;</span>%= octicon &quot;x&quot;, :&quot;aria-label&quot; =&gt; &quot;Close&quot; %&gt;
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/With%20action%20button" className="dashAnchor" />
          <h2>
            <a id="with-action-button" className="anchor" href="#with-action-button" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>A flash message with an action button.</p>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;btn btn-sm primary flash-action&quot;</span>
                <span className="nt">&gt;</span>Complete action<span className="nt">&lt;/button&gt;</span>
                Flash message with action here.
                <span className="nt">&lt;/div&gt;</span>
              </code>
            </pre>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Full%20width%20flash" className="dashAnchor" />
          <h2>
            <a id="full-width-flash" className="anchor" href="#full-width-flash" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>A flash message that is full width and removes border and border radius.</p>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;container&quot;</span>
                <span className="nt">&gt;</span>
