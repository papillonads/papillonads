  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/components/progress/" aria-current="page" className="text-gray">
                Progress
              </a>
            </li>
          </ol>
        ...
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Progress</h2>

        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            <a
              href="https://github.com/primer/primer/issues/new?title=primer-progress"
            ...
            <a
              href="https://github.com/primer/primer/tree/master/modules/primer-progress/"
          ...
          <div className="d-inline-block Box mr-3">
            ...
            <a className="d-inline-block px-2 py-1" href="https://npmjs.com/package/primer-progress">
              0.1.1
            </a>
          </div>
        ...
        <div className="markdown-body">
          <p>Use Progress components to visualize task completion.</p>
          <a name="//apple_ref/cpp/Style/Default%20Progress" className="dashAnchor" />
          <h2>
            <a id="default-progress" className="anchor" href="#default-progress" aria-hidden="true">
        ...
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <span className="Progress">
            <span className="Progress-value bg-green" style={{ width: '50%' }} />
          </span>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress-value bg-green&quot;</span> <span className="na">style=</span>
                <span className="s">&quot;width: 50%;&quot;</span>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Large%20Progress" className="dashAnchor" />
          <h2>
            <a id="large-progress" className="anchor" href="#large-progress" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress Progress--large&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress-value bg-green&quot;</span> <span className="na">style=</span>
                <span className="s">&quot;width: 50%;&quot;</span>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Small%20Progress" className="dashAnchor" />
          <h2>
            <a id="small-progress" className="anchor" href="#small-progress" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
        ...
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress Progress--small&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress-value bg-green&quot;</span> <span className="na">style=</span>
                <span className="s">&quot;width: 50%;&quot;</span>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Progress%20with%20tooltip" className="dashAnchor" />
          <h2>
            <a id="progress-with-tooltip" className="anchor" href="#progress-with-tooltip" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
        ...
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="tooltipped tooltipped-n" aria-label="78 done / 6 in progress / 2 to do">
            <span className="Progress">
              <span className="Progress-value bg-green" style={{ width: '50%' }} />
            </span>
          </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="s">&quot;tooltipped tooltipped-n&quot;</span> <span className="na">aria-label=</span>
                <span className="s">&quot;78 done / 6 in progress / 2 to do&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress&quot;</span>
                <span className="nt">&gt;</span>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Progress%20with%20multiple%20values" className="dashAnchor" />
          <h2>
            <a id="progress-with-multiple-values" className="anchor" href="#progress-with-multiple-values" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
        ...
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="tooltipped tooltipped-n" aria-label="78 done / 6 in progress / 2 to do">
            <span className="Progress">
              <span className="Progress-value bg-green" style={{ width: '50%' }} />
              <span className="Progress-value bg-purple" style={{ width: '25%' }} />
              <span className="Progress-value bg-red" style={{ width: '5%' }} />
            </span>
          </div>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&gt;&lt;/span&gt;</span>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress-value bg-purple&quot;</span> <span className="na">style=</span>
                <span className="s">&quot;width: 25%;&quot;</span>
                <span className="nt">&gt;&lt;/span&gt;</span>
                <span className="nt">&lt;span</span> <span className="na">class=</span>
                <span className="s">&quot;Progress-value bg-red&quot;</span> <span className="na">style=</span>
                <span className="s">&quot;width: 5%;&quot;</span>
                <span className="nt">&gt;&lt;/span&gt;</span>
                <span className="nt">&lt;/span&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
              </code>
      ...
      <div className="mt-4 d-flex flex-justify-between">
        ...
        <div className="align-right">
          <a href="/primer/components/subhead/">
            Subhead
            <svg
              height="14"
