  ...
  return (
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/components/boxed-groups/" aria-current="page" className="text-gray">
                Boxed groups
              </a>
            </li>
          </ol>
        ...
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Boxed groups</h2>
        ...
        <div className="border-top border-bottom py-3 mb-4 clearfix">
          <div className="float-right">
            ...
            <a
              href="https://github.com/github/github/blob/master/app/assets/stylesheets/components/boxed-groups.scss"
        ...
        <div className="markdown-body">
          <p>
            The <code>boxed-group</code> styles have been deprecated. Please use the <a href="/primer/components/box/">Box</a> component
            instead.
          </p>
        </div>
      </div>
