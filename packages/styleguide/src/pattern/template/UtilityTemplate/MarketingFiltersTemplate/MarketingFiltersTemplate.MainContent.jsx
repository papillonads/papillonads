    ...
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/utilities/marketing-filters/" aria-current="page" className="text-gray">
                Filters
              </a>
            </li>
          </ol>
        </nav>
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Filters</h2>
        ...
        <div className="markdown-body">
          <p>Filter utility classes can be applied to divs or images to apply visual effects.</p>
          <div className="flash flash-warn">
            Note: CSS filters are <a href="http://caniuse.com/#feat=css-filters">not supported by IE</a>
          </div>
          <a name="//apple_ref/cpp/Style/Grayscale" className="dashAnchor" />
          <h2>
            <a id="grayscale" className="anchor" href="#grayscale" aria-hidden="true">
          ...
          <p>
            Applying <code>.grayscale</code> to an element will remove all of its colors, and make it render in black and white.
          </p>
        </div>
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <img src="https://assets-cdn.github.com/images/modules/site/home-illo-business.svg" className="img-responsive grayscale" alt="" />
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="err">/</span>
                <span className="na">home-illo-business</span>
                <span className="err">.</span>
                <span className="na">svg</span>
                <span className="err">&quot;</span> <span className="err">%</span>
                <span className="nt">&gt;</span>&quot; className=&quot;img-responsive grayscale&quot; alt=&quot;&quot;&gt;
              </code>
            </pre>
          </div>
          <button
