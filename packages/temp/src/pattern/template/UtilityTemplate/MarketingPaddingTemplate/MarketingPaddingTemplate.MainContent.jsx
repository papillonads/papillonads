    ...
    <main className="flex-row flex-lg-column main-content mt-4 mt-lg-6 pb-6 mx-auto px-3" id="js-pjax-container" data-pjax-container="">
      <div className="clearfix">
        <nav aria-label="Breadcrumb" data-pjax="">
          <ol>
            ...
            <li className="breadcrumb-item text-small breadcrumb-item-selected">
              <a href="/primer/utilities/marketing-padding/" aria-current="page" className="text-gray">
                Marketing padding
              </a>
            </li>
          </ol>
        </nav>
        <h2 className="f00-light border-0 pb-3 d-block v-align-middle mt-2">Marketing padding</h2>
        ...
        <div className="markdown-body">
          <p>
            Marketing padding utilities extend <a href="../../support/spacing">core margin utilities</a> across the y-axis only. The{' '}
          ...
          <a name="//apple_ref/cpp/Style/Y-axis%20padding%20utilities" className="dashAnchor" />
          <h2>
            <a id="y-axis-padding-utilities" className="anchor" href="#y-axis-padding-utilities" aria-hidden="true">
          ...
          <p>
            Use marketing padding utilities to apply padding to top, bottom, or both y-axis of an element. These utilities can change or
            override default padding, and can be used with a spacing scale of 7-12.
          </p>
        </div>
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="margin-orange d-inline-block">
            <div className="d-inline-block block-blue pt-7">.pt-7</div>
          </div>
          <div className="margin-orange d-inline-block">
            <div className="d-inline-block block-blue pb-7">.pb-7</div>
          </div>
          <div className="margin-orange d-inline-block">
            <div className="d-inline-block block-blue py-7">.py-7</div>
          </div>
        </div>
          ...
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;d-inline-block block-blue pt-7&quot;</span>
                <span className="nt">&gt;</span>.pt-7<span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;margin-orange d-inline-block&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;d-inline-block block-blue pb-7&quot;</span>
                <span className="nt">&gt;</span>.pb-7<span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;margin-orange d-inline-block&quot;</span>
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;d-inline-block block-blue py-7&quot;</span>
                <span className="nt">&gt;</span>.py-7<span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
              </code>
            </pre>
          </div>
        ...
        <div className="markdown-body">
          <a name="//apple_ref/cpp/Style/Responsive%20y-axis%20padding%20utilities" className="dashAnchor" />
          <h2>
            <a id="responsive-y-axis-padding-utilities" className="anchor" href="#responsive-y-axis-padding-utilities" aria-hidden="true">
              <svg className="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                <path
                  fillRule="evenodd"
                  d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"
          ...
          <p>
            All marketing padding utilities can be adjusted per <a href="../../objects/grid#breakpoints">breakpoint</a> using the following
            formula: <code>p[y-direction]-[breakpoint]-[spacer]</code>. Each responsive style is applied to the specified breakpoint and up.
          </p>
        </div>
        <div className="mt-3 position-relative clearfix p-3 styleguide-example border border-gray-light">
          <div className="d-inline-block margin-orange">
            <div className="py-sm-7 pb-lg-9 d-inline-block block-blue">.py-sm-7 .pb-lg-9</div>
          </div>
        </div>
        <div className="markdown-body mb-3 position-relative clipboard-reveal js-zeroclipboard-container">
          <div className="js-zeroclipboard-target">
            <pre className="highlight-html highlight">
              <code>
                ...
                <span className="nt">&gt;</span>
                <span className="nt">&lt;div</span> <span className="na">className=</span>
                <span className="s">&quot;py-sm-7 pb-lg-9 d-inline-block block-blue&quot;</span>
                <span className="nt">&gt;</span>
                .py-sm-7 .pb-lg-9
                <span className="nt">&lt;/div&gt;</span>
                <span className="nt">&lt;/div&gt;</span>
      ...
      <div className="mt-4 d-flex flex-justify-between">
        <div>
          <a href="/primer/utilities/marketing-margin/">
            <svg
              height="14"
